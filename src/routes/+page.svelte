<script lang="ts">
    ...
    $: {
      const volumeParam = parseFloat($page.url.searchParams.get('volume') || `${volume}`);
...
<div class="space-y-6">
  ...
  <div class="grid grid-cols-[auto,1fr,auto] gap-4 text-sm font-medium text-muted-foreground">
